...
public class BusinChance implements Serializable {
    ...
    private int hasSupCat;              //是否有类目(0 有 1 没有)
    ...
    private String detailImageType;     //详细内容图片宽度分布 (0,0,0,0 --- 700以上,500至700,300至500,300以下)

    private int thanSevenHundred;       //详细内容图片宽度 700以上的图片数量

    private int fiveBetweenSeven;       //详细内容图片宽度 500至700的图片数量

    private int threeBetweenFive;       //详细内容图片宽度 300至500的图片数量

    private int lessThreeHundred;       //详细内容图片宽度 300以下的图片数量
    ...
    private List<Suggest> perfectSuggest;       //优化建议
    ...
    public List<Suggest> getPerfectSuggest() {
        return perfectSuggest;
    }

    public void setPerfectSuggest(List<Suggest> perfectSuggest) {
        this.perfectSuggest = perfectSuggest;
    }
}
